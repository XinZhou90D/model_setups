...
#This analysis wrapper runs the underlying "tem_diags_p39.py" script written by Pu Lin. It takes 6 hourly instantaneous 
#ua, va, ta, wap fields on 39 pressure levels and outputs daily and monthly zonal averages for DynVarMIP diagnostics. 
...
#original 6hr files in the format /atmos_plev39_6hr/ts/{daily,monthly}/1yr/ .
...
set diagnostic_script = "${xml_dir}/awg_include/analysis/stub/tem_diags_p39.py"
